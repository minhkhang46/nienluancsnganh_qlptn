...
<body class="antialiased bg-white font-sans text-gray-900" style="background-color: rgb(186 230 253)">
    ...
    <section class=" bg-gray-100 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-16 lg:py-28"
        ...
        <div class="flex flex-col lg:flex-row lg:-mx-8">
            <div class="w-full ">
                <h1 class="text-2xl leading-tight font-bold mt-4 text-center text-blue-700">PHÒNG THÍ NGHIỆM VẬT LIỆU Y
                    SINH</h1>
                <h2 class="text-xl leading-tight font-bold mt-4 text-center text-blue-700">BIOMEDICAL MATERIALS
                    LABORATORY</h2>
                <h3 class="text-xl leading-relaxed mt-5 px-64 text-blue-700">Nhiệm vụ</h3>
                <p class="mt-2 leading-relaxed px-72 text-justify">Phòng thí nghiệm vật liệu y sinh được thiết lập nhầm
                    thực hiện các nghiên cứu liên quan đến vật liệu ứng dụng trong lĩnh vực y sinh
                    và hỗ trợ các giảng dạy ngành Công nghệ Kỹ thuật hóa học và Kỹ thuật Vật liệu.</p>
                ...
                <ul class="mt-2 leading-relaxed px-72 text-justify">
                    <li>Nghiên cứu trích ly collagen da và bong bóng cá sử dụng chế tạo vật liệu tương hợp học như
                        scaffold, hydrogel và các hệ dẫn truyền</li>
                    <li>Nghiên cứu chế tạo các khoáng vô cô từ các phế phẩm vỏ sò, vỏ trứng, xương động vật ứng dụng
                        trong chế tạo vật liệu, y học và phực phẩm</li>
                    <li>Nghiên cứu chế tạo các hệ dẫn truyền thuốc hiệu quả</li>
                    <li>Khảo sát và đánh giá hoạt tính sinh học của các vật liệu</li>
                </ul>
                <h3 class="text-xl leading-relaxed mt-3 px-64 text-blue-700">Phòng thí nghiệm</h3>
                <div class="mt-2 leading-relaxed px-72">
                    <a class="text-justify">Phòng thí nghiệm kỹ thuật vật liệu y sinh 1 </a>
                    ...
                    <a class="text-justify">Phòng thí nghiệm kỹ thuật vật liệu y sinh 2 </a>
                    <div class="flex items-center mb-4 px-10">
                        <input id="default-radio-1" type="radio" value="" name="default-radio"
                            class="mt-2 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="default-radio-1" class="mt-2 leading-relaxed px-2">Phòng đã đăng ký</label>
                    ...
                    <a class="text-justify">Phòng thí nghiệm kỹ thuật vật liệu y sinh 3 </a>
                    <div class="flex items-center mb-4 px-10">
                        <input id="default-radio-1" type="radio" value="" name="default-radio"
                            class="mt-2 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="default-radio-1" class="mt-2 leading-relaxed px-2">Phòng đã đăng ký</label>
                        ...
                        <tbody>
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 test-sm">
                                <th scope="row"
                                    ...
                                    Critical Point Dryer (Autosamdri®-931, Tousimis)</th>
                                <td class="px-20 py-4 text-gray-900 text-justify">Sử dụng nghiên ứu tế bào và hydrogel
                                </td>
                            </tr>
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 test-sm">
                                <th scope="row"
                                    class="px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white text-justify">
                                    Microplate Reader (2100-C, Comecta)</th>
                                <td class="px-20 py-4 text-gray-900 text-justify"> Đo mật độ quang của dung dịch</td>
                            </tr>
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 test-sm">
                                <th scope="row"
                                    class="px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white text-justify"> CO2
                                    Incubator (CB 53, Binder)</th>
                                <td class="px-20 py-4 text-gray-900 text-justify">Nuôi cấy tế bào</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
