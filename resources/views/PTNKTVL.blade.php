...
<body class="antialiased bg-white font-sans text-gray-900" style="background-color: rgb(186 230 253)">
    ...
    <section class=" bg-gray-100 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-16 lg:py-28"
        ...
        <div class="flex flex-col lg:flex-row lg:-mx-8">
            <div class="w-full ">
                <h1 class="text-2xl leading-tight font-bold mt-4 text-center text-blue-700">PHÒNG THÍ NGHIỆM KỸ THUẬT
                    VẬT LIỆU</h1>
                <h2 class="text-xl leading-tight font-bold mt-4 text-center text-blue-700">MATERIALS ENGINEERING
                    LABORATORY</h2>
                <h3 class="text-xl leading-relaxed mt-5 px-64 text-blue-700">Nhiệm vụ</h3>
                <p class="mt-2 leading-relaxed px-72 text-justify">Phòng thí nghiệm kỹ thuật vật liệu được thành lập
                    nhầm phục vụ công tác giảng dạy thực tập, thực hành đồ án, nghiên cứu khoa học
                    và luận văn tốt nghiệp của sinh viên, học viên ngành Công nghệ Kỹ thuật hóa học và Kỹ thuật Vật
                    liệu.</p>
                ...
                <ul class="mt-2 leading-relaxed px-72 text-justify">
                    <li>Gia công và khảo sát tính chất vật liệu composite sợi tự nhiên và sợ tổng hợp </li>
                    <li>Tổng hợp vật liệu xúc tác hấp phụ</li>
                </ul>
                <h3 class="text-xl leading-relaxed mt-3 px-64 text-blue-700">Phòng thí nghiệm</h3>
                <div class="mt-2 leading-relaxed px-72">
                    <a class="text-justify">Phòng thí nghiệm kỹ thuật vật liệu 1 </a>
                    ...
                    <a class="text-justify">Phòng thí nghiệm kỹ thuật vật liệu 2 </a>
                    <div class="flex items-center mb-4 px-10">
                        <input id="default-radio-1" type="radio" value="" name="default-radio"
                            class="mt-2 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="default-radio-1" class="mt-2 leading-relaxed px-2">Phòng đã đăng ký</label>
                    ...
                    <table class="table-fixed text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xm text-gray-700 uppercase bg-gray-400 dark:bg-gray-900 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="text-center px-52 py-3">Tính Năng Thiết Bị</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 test-sm">
                                <th scope="row"
                                    ...
                                    Microfine Grinder, IKA, MF10 </th>
                                <td class="px-20 py-4 text-gray-900 text-justify">Nghiền vật liệu rắn xốp</td>
                            </tr>
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 test-sm">
                                <th scope="row"
                                    class="px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white text-justify">
                                    Granular & Roller Press Conveyor, Pulian, Ah-160</th>
                                <td class="px-20 py-4 text-gray-900 text-justify">Nghiền và cán vật liệu</td>
                            </tr>
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 test-sm">
                                <th scope="row"
                                    class="px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white text-justify">Heat
                                    distortion tester, Yasuda, 148-HD500</th>
                                <td class="px-20 py-4 text-gray-900 text-justify">Xác định khả năng chịu nhiệt của vật
                                    liệu</td>
                            </tr>
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 test-sm">
                                <th scope="row"
                                    class="px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white text-justify">
                                    Flammability tester, Yasuda, 252-UL94</th>
                                <td class="px-20 py-4 text-gray-900 text-justify">Xác định khả năng đốt cháy của vật
                                    liệu</td>
                            </tr>
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 test-sm">
                                <th scope="row"
                                    class="px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white text-justify">Aging
                                    Oven, Yasuda, 102-SHF-S</th>
                                <td class="px-20 py-4 text-gray-900 text-justify">Xác định độ lão hóa của vật liệu</td>
                            </tr>
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 test-sm">
                                <th scope="row"
                                    class="px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white text-justify">Sieve
                                    Set, Retsch, AS200 Control</th>
                                <td class="px-20 py-4 text-gray-900 text-justify">Rây vật liệu rời</td>
                            </tr>
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 test-sm">
                                <th scope="row"
                                    class="px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white text-justify">Oven,
                                    Memmert, VO200 </th>
                                <td class="px-20 py-4 text-gray-900 text-justify">Nung vật liệu</td>
                            </tr>
