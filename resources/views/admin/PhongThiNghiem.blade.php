...
<div class="antialiased font-sans text-gray-900">
    ...
    <form method="POST" action="{{route('PTN')}}" enctype="multipart/form-data">
        @csrf
        <div class="pt-44 flex items-center justify-center">
            <div class="container max-w-screen-lg mx-auto">
                <div>
                    <h1 class="font-semibold text-3xl text-indigo-700 mb-8 text-center ">Phòng Thí Nghiệm</h1>
                    <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6 flex flex-wrap">
                        <div class="w-full md:w-1/2 pr-2">
                            ...
                            <input type="text" name="idPTN" id="idPTN"
                                ...
                                placeholder="Nhập ID Phòng Thí Nghiệm" />
                        </div>
                        <div class="w-full md:w-1/2 pl-2">
                            ...
                            <input type="text" name="TenPTN" id="TenPTN"
                                ...
                                placeholder="Nhập Tên Phòng Thí Nghiệm" />
                        </div>
                        <div class="w-full">
                            <label for="Nhiemvu">Nhiệm Vụ</label>
                            <textarea type="text" name="Nhiemvu" id="Nhiemvu"
                                class="h-20 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('email') }}"
                                placeholder="Nhập Nhiệm vụ"></textarea>
                        </div>
                        <div class="w-full">
                            <label for="Nghiencuu">Hướng Nghiên Cứu</label>
                            <textarea type="text" name="Nghiencuu" id="Nghiencuu"
                                class="h-20 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="Nhập Hướng Nghiên Cứu"></textarea>

                        </div>
                        <div class="w-full">
                            <label for="image">Hình ảnh</label>
                            <input type="file" name="image" id="image" class="border mt-1 rounded w-full bg-gray-50">
                        </div>
                    </div>
                    <button name="LABS"
                        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-center w-full mt-4  justify-center"
                        type="submit">Thêm Phòng Thí Nghiệm</button>
                </div>
            </div>
        </div>
    </form>
    ...
    @if (Session::has('Tạo Phòng Thí Nghiệm Không Thành Công'))
    <script>
    window.onload = function() {
        swal('Tạo Phòng Thí Nghiệm Không Thành Công', '{{ Session::get('
            Tạo Phòng Thí Nghiệm Không Thành Công ') }}', 'error', {
                button: true,
                button: 'OK',
                timer: 5000,
            });
    ...
    @if (Session::has('Tạo Phòng Thí Nghiệm Thành Công') && Session::get('Tạo Phòng Thí Nghiệm Thành Công') !== false)
    <script>
    window.onload = function() {
        swal('Tạo Phòng Thí Nghiệm Thành Công', '{{ Session::get('
            Tạo Phòng Thí Nghiệm Thành Công') }}', 'success').then(function() {
