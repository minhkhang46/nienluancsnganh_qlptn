...
<div class="antialiased font-sans text-gray-900">
                    ...
                    <div>
                        ...
                        <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6 flex flex-wrap">
                            <div class="w-full md:w-1/2 pr-2">
                                <label for="idPTN">ID Phòng   Nghiệm</label>
                            ...
                            <div class="w-full">
                                ...
                                <textarea type="text" name="Nhiemvu" id="Nhiemvu" l
                                    ...
                                    placeholder="Nhập Nhiệm vụ">{{$l->Nhiemvu}}</textarea>
                            </div>
                            <div class="w-full">
                                <label for="Nghiencuu">Hướng Nghiên Cứu</label>
                                <textarea type="text" name="Nghiencuu" id="Nghiencuu" 
                                    class="h-20 border mt-1 rounded px-4 w-full bg-gray-50"
                                    placeholder="Nhập Hướng Nghiên Cứu">{{$l->Nghiencuu}}</textarea>
    ...
    window.onload = function() {
        swal('đợi admin xử lý yêu cầu trước đó', '{{ Session::get('
            đợi admin xử lý yêu cầu trước đó ') }}', 'error', {
                button: true,
                button: 'OK',
                timer: 5000,
            });
