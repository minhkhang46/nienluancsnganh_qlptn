...
<div class="antialiased font-sans text-gray-900">
                ...
                <div>
                    ...
                    <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6 flex flex-wrap">
                        ...
                        <div class="w-full">
                            ...
                            <textarea type="text" name="tinhnang" id="tinhnang" l
    ...
    @if (Session::has('Thêm Thiết Bị Thành Công') && Session::get('Thêm Thiết Bị Thành Công') !== false)
    <script>
    window.onload = function() {
        swal('Thêm Thiết Bị Thành Công', '{{ Session::get('
            Thêm Thiết Bị Thành Công ') }}', 'success').then(function() {
            window.location.href = '{{ route('dsthietbi') }}';
        });
    }
    </script>
    <?php Session::forget('Thêm Thiết Bị Thành Công'); ?>
    @endif
