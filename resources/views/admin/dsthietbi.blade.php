                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800 text-xl text-center">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <a href="{{ route('deletetb', ['id'=> $de->idthietbi]) }}"
                                ...
                                <form id="delete-form" action="{{ route('deletetb', ['id' =>$de->idthietbi]) }}"
                            ...
                            <th class="px-4 py-3">
                                <form action="{{ route('update_tb', ['id' => $de->idthietbi]) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <label for="tinhnang">Tính Năng</label>
                                        <input type="tinhnang" name="tinhnang" id="tinhnang"
