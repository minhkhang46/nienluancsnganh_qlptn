...
<div class="antialiased font-sans text-gray-900">
                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800 text-xl text-center">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                @if (!$u->status )
                                    <a href="{{ route('update_route', ['idUser' => $u->idUser, 'idPTN' => $u->idPTN, 'update_time' => $u->update_time, 'date' => $u->date ]) }}">
                                        <img src="/my-project2/public/images/yes.png" alt="Logo" class="h-8 "></a>
                                    <a href="{{ route('update_routeRefuse', ['idUser' => $u->idUser, 'idPTN' => $u->idPTN, 'update_time' => $u->update_time, 'date' => $u->date ]) }}">
                                        <img src="/my-project2/public/images/close.png" alt="Logo" class="h-8 "></a>
                                @else
                                    @if($u->yesno)
                                        <a class="justify-center content-center">
                                            <img src="/my-project2/public/images/yes.png" alt="Logo" class="h-12 "> 
                                    ...
                                    @else 
                                        <a class="justify-center content-center">
                                            <img src="/my-project2/public/images/close.png" alt="Logo" class="h-12 "> 
                                        </a>
                                    @endif
                                @endif
    ...
    @if (Session::has('Cập Nhật Thất Bại'))
        <script>
            window.onload = function() {
                swal('Cập Nhật Thất Bại', '{{ Session::get('Cập Nhật Thất Bại') }}', 'error').then(function() {
                    window.location.href = '{{ route('danhsachadmin') }}';
                });
            }
        </script>
